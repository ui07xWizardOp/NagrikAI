import { Award, CheckCircle, Flag, Settings, Shield, Star, Trophy } from "lucide-react";

export default function Profile({ setView }: { setView: (v: "settings") => void }) {
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in pb-12">
      <header className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-text-primary mb-2 tracking-tight">Citizen Profile</h1>
          <p className="text-text-secondary">Your impact, trust score, and civic achievements.</p>
        </div>
        <button 
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-8 mt-12">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-center mt-2">
              <div className="text-2xl font-black tracking-tight">Rohan Sharma</div>
              <div className="text-sm font-medium text-accent uppercase tracking-widest mt-1">Verified Citizen</div>
            </div>
          </div>
          ...
          <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-4 w-full pt-4">
            <div className="bg-surface-muted/50 rounded-2xl p-4 border border-border-subtle text-center">
              <div className="text-3xl font-black text-text-primary mb-1">98</div>
              <div className="text-xs font-semibold text-text-secondary uppercase tracking-wider">Trust Score</div>
            </div>
            <div className="bg-surface-muted/50 rounded-2xl p-4 border border-border-subtle text-center">
              <div className="text-3xl font-black text-text-primary mb-1">2,450</div>
              <div className="text-xs font-semibold text-text-secondary uppercase tracking-wider">Karma Points</div>
            </div>
            <div className="bg-surface-muted/50 rounded-2xl p-4 border border-border-subtle text-center">
              <div className="text-3xl font-black text-text-primary mb-1">42</div>
              <div className="text-xs font-semibold text-text-secondary uppercase tracking-wider">Reports</div>
            </div>
            <div className="bg-surface-muted/50 rounded-2xl p-4 border border-border-subtle text-center">
              <div className="text-3xl font-black text-text-primary mb-1">128</div>
              <div className="text-xs font-semibold text-text-secondary uppercase tracking-wider">Verifications</div>
            </div>
          </div>
        </div>
      </div>
        ...
        <section className="bg-surface-card border border-border-default rounded-3xl p-8 shadow-sm">
          ...
          <div className="mt-8 p-4 bg-accent/5 border border-accent/20 rounded-xl flex items-start gap-3">
            ...
            <p className="text-sm text-text-secondary leading-relaxed">
              Your high trust score allows your reports to bypass manual moderation and instantly queue for agency resolution.
            </p>
          </div>
        </section>
        ...
        <section className="bg-surface-card border border-border-default rounded-3xl p-8 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col items-center justify-center p-6 border border-border-default rounded-2xl bg-surface-canvas shadow-sm relative overflow-hidden group">
              ...
              <div className="text-xs text-text-muted text-center mt-1">100+ verified reports</div>
            </div>
            <div className="flex flex-col items-center justify-center p-6 border border-border-default rounded-2xl bg-surface-canvas shadow-sm relative overflow-hidden group">
              ...
              <div className="text-xs text-text-muted text-center mt-1">Perfect accuracy</div>
            </div>
            <div className="flex flex-col items-center justify-center p-6 border border-border-default rounded-2xl bg-surface-canvas shadow-sm relative overflow-hidden group">
              ...
              <div className="text-xs text-text-muted text-center mt-1">Active in Ward 142</div>
            </div>
            <div className="flex flex-col items-center justify-center p-6 border border-border-subtle border-dashed rounded-2xl bg-surface-muted text-text-muted">
              ...
              <div className="text-xxs text-center mt-1">200 reports needed</div>
            </div>
          </div>
        </section>
      </div>
