...
import { Moon, Sun, Bell, Globe, Shield, LogOut, Smartphone } from "lucide-react";

export default function Settings({ setView }: { setView: (v: string) => void }) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in pb-12">
      <header>
        <h1 className="text-3xl font-bold text-text-primary mb-2 tracking-tight">Settings</h1>
        <p className="text-text-secondary">Manage your preferences, appearance, and account.</p>
      </header>
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        <div className="lg:col-span-2 space-y-8">
          ...
          <section className="bg-surface-card border border-border-default rounded-2xl p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-lg font-semibold text-text-primary">Language & Region</h2>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 rounded-xl border border-border-subtle bg-surface-muted/50">
                <div>
                  ...
                  <p className="text-sm text-text-secondary mt-1">Receive alerts on your device for updates.</p>
                </div>
                <button 
              ...
              <div className="flex items-center justify-between p-4 rounded-xl border border-border-subtle bg-surface-muted/50">
                <div>
                  <h3 className="font-medium text-text-primary">Email Updates</h3>
                  <p className="text-sm text-text-secondary mt-1">Weekly digest of community improvements.</p>
                </div>
                <button 
        ...
        <div className="space-y-8">
          <section className="bg-surface-card border border-border-default rounded-2xl p-6 shadow-sm">
            ...
            <div className="space-y-4">
              <button className="w-full text-left p-3 rounded-xl border border-border-subtle hover:bg-surface-muted transition-colors text-sm font-medium text-text-primary flex items-center justify-between group">
                Change Password
          ...
          <div className="text-center">
            <p className="text-xs text-text-muted font-mono">
              ...
              <br />
              <a href="#" className="text-accent hover:underline mt-1 inline-block">Terms of Service</a> &bull; <a href="#" className="text-accent hover:underline mt-1 inline-block">Privacy Policy</a>
            </p>
          </div>
        </div>
      </div>
